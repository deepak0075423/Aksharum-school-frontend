...
const ADMIN_NAV = [
  ...
  { to: '/admin/hostel/dashboard',  icon: '🏨', label: 'Hostel',        module: 'hostel' },
...
const STUDENT_NAV = [
  ...
  { to: '/student/hostel',          icon: '🏨', label: 'Hostel',        module: 'hostel' },
...
const PARENT_NAV = [
  ...
  { to: '/parent/hostel',           icon: '🏨', label: 'Hostel',        module: 'hostel' },
