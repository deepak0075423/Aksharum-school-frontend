...
const PATHS = {
  ...
  calculator:  <><rect x="5" y="2.8" width="14" height="18.4" rx="2.2" /><rect x="8" y="5.8" width="8" height="3.6" rx=".8" /><path d="M8.6 13h.01M12 13h.01M15.4 13h.01M8.6 16.6h.01M12 16.6h.01M15.4 16.6h.01" strokeWidth="2.4" /></>,
  brain:       <><path d="M9.5 4.2A2.8 2.8 0 0 0 6.8 6.6 3 3 0 0 0 4.5 10a3 3 0 0 0 .7 4.4 3.1 3.1 0 0 0 2.6 4.4 2.8 2.8 0 0 0 4.2 1V5.3a2.6 2.6 0 0 0-2.5-1.1z" /><path d="M14.5 4.2a2.8 2.8 0 0 1 2.7 2.4A3 3 0 0 1 19.5 10a3 3 0 0 1-.7 4.4 3.1 3.1 0 0 1-2.6 4.4 2.8 2.8 0 0 1-4.2 1" /><path d="M8.6 9.4c1 .1 1.8.8 2 1.8M15.4 9.4c-1 .1-1.8.8-2 1.8M8.4 14.6c.9-.4 1.9-.2 2.6.5M15.6 14.6c-.9-.4-1.9-.2-2.6.5" /></>,
  flask:       <><path d="M9.5 3h5M10.2 3v6.2L4.8 18.4A1.8 1.8 0 0 0 6.4 21h11.2a1.8 1.8 0 0 0 1.6-2.6l-5.4-9.2V3" /><path d="M7.3 14.6h9.4" /></>,
  ...
  eyeOff:      <><path d="M9.9 6.1A9.6 9.6 0 0 1 12 5.8C18 5.8 21.5 12 21.5 12a17 17 0 0 1-2.6 3.4M6.3 7.6C3.9 9.2 2.5 12 2.5 12S6 18.2 12 18.2a9.3 9.3 0 0 0 4.4-1.1" /><path d="M9.8 9.8a3.1 3.1 0 0 0 4.4 4.4" /><path d="m3.5 3.5 17 17" /></>,
  ...
  trendDown:   <><path d="M3.5 7.5 9 13l3.6-3.6 7.9 8" /><path d="M15.6 17.9h4.9V13" /></>,
  arrowUpRight:   <path d="M7 17 17 7M8.5 7H17v8.5" />,
  arrowDownRight: <path d="M7 7l10 10M17 8.5V17H8.5" />,
  history:     <><path d="M3.8 12a8.2 8.2 0 1 0 2.4-5.8" /><path d="M3.5 3.8v4.6h4.6" /><path d="M12 7.6V12l3 1.9" /></>,
  save:        <><path d="M5.6 3.5h10.2l4.7 4.7v10.2a2.1 2.1 0 0 1-2.1 2.1H5.6a2.1 2.1 0 0 1-2.1-2.1V5.6a2.1 2.1 0 0 1 2.1-2.1z" /><path d="M7.5 3.5v5h7.5v-5M7.5 20.5v-6.2h9v6.2" /></>,
  crown:       <path d="M3.5 8.2 8 12l4-6.5 4 6.5 4.5-3.8-1.8 10.3H5.3z" />,
  gauge:       <><path d="M3.8 16.5a8.2 8.2 0 1 1 16.4 0" /><path d="m12 16.5 3.6-4.6" /><path d="M3.8 16.5h2M18.2 16.5h2" /></>,
  wand:        <><path d="m4 20 9.5-9.5" /><path d="m12.2 9.2 2.6 2.6" /><path d="M16 3.5v2.6M19.5 7h-2.6M18.6 4.4 17 6M15.5 11.5v1.8M21 9.5h-1.8" /></>,
  externalLink:<><path d="M14 3.8h6.2V10" /><path d="m20.2 3.8-8.7 8.7" /><path d="M18 13.8v5a1.4 1.4 0 0 1-1.4 1.4H5.2a1.4 1.4 0 0 1-1.4-1.4V7.4A1.4 1.4 0 0 1 5.2 6h5" /></>,
  listDots:    <><path d="M9 6.5h11M9 12h11M9 17.5h11" /><circle cx="4.6" cy="6.5" r="1.1" /><circle cx="4.6" cy="12" r="1.1" /><circle cx="4.6" cy="17.5" r="1.1" /></>,
  halfDay:     <><circle cx="12" cy="12" r="3.6" /><path d="M12 3.5v2M12 18.5v2M3.5 12h2M18.5 12h2M6 6l1.4 1.4M16.6 16.6 18 18M6 18l1.4-1.4M16.6 7.4 18 6" /></>,
  percent:     <><path d="M18.5 5.5 5.5 18.5" /><circle cx="7.2" cy="7.2" r="2.4" /><circle cx="16.8" cy="16.8" r="2.4" /></>,
  shieldCheck: <><path d="M12 3.2 19.5 6v5.6c0 4.6-3.2 8.2-7.5 9.3-4.3-1.1-7.5-4.7-7.5-9.3V6z" /><path d="m8.6 12.1 2.4 2.4 4.4-4.6" /></>,
  ...
  lock:        <><rect x="4.5" y="10.5" width="15" height="10.5" rx="2.4" /><path d="M8 10.5V7.6a4 4 0 0 1 8 0v2.9" /><path d="M12 14.6v2.6" /></>,
  shield:      <path d="M12 3 4.8 5.8v5.4c0 4.6 3 8.2 7.2 9.8 4.2-1.6 7.2-5.2 7.2-9.8V5.8z" />,
  gradCap:     <><path d="M2.5 9.2 12 5l9.5 4.2L12 13.4z" /><path d="M6.3 11v4.2c0 1.7 2.6 3.3 5.7 3.3s5.7-1.6 5.7-3.3V11" /><path d="M21.5 9.2v5" /></>,
  barsUp:      <><path d="M6.5 19.5v-5" /><path d="M12 19.5V10" /><path d="M17.5 19.5v-14" /></>,
