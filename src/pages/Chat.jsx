...
export default function Chat() {
  ...
  // Presence clock — re-render so relative "last seen" labels stay current.
  // The chat list itself is refreshed by socket events (see socket wiring
  // below), so there's no polling here.
  useEffect(() => {
